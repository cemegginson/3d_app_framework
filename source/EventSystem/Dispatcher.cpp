...
void Dispatcher::Initialize() {
    if(!inited) {
        ...
        dispatchEvents  = std::deque<std::pair<double,std::shared_ptr<void>>>();
        mappedEvents    = std::map<int,std::list<Subscriber*>*>();
        threadQueue     = std::deque<std::pair<Subscriber*, std::shared_ptr<void>>>();
